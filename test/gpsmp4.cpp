//
//######################################################################
//            CAMgraphicsProcess Sample Program  #4
//
...
int main()
{
    ...
    Gprocess.title("Contour Plot 1 : Default Style");

    Gprocess.contour(z,n,n);                    // create the contour plot
    Gprocess.frame();                           // "frame" the plot

    Gprocess.title("Contour Plot 2 : Fixed # of Contours");

    int nContour = 8;                    // use 8 contours
    Gprocess.contourLineLabelsOn();             // Turn on line labels
    Gprocess.contour(z,n,n,nContour);           // create the contour plot
    Gprocess.frame();                           // "frame" the plot

    Gprocess.title("Contour Plot 3 : Fixed Contour Increment");

    double    cIncrement = .5;           // contour increment of .5
    Gprocess.contourLineLabelsOff();            // Turn off line labels
    Gprocess.contour(z,n,n,cIncrement);         // create the contour plot
    Gprocess.frame();                           // "frame" the plot
